...
# summit_blood_samples/
APPS_DIR = ROOT_DIR / "summit_blood_samples"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "summit_blood_samples.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "summit_blood_samples.utils.context_processors.settings_context",
            ],
        },
    }
]
...
# # https://django-allauth.readthedocs.io/en/latest/configuration.html
# ACCOUNT_ADAPTER = "summit_blood_samples.users.adapters.AccountAdapter"
# # https://django-allauth.readthedocs.io/en/latest/configuration.html
# SOCIALACCOUNT_ADAPTER = "summit_blood_samples.users.adapters.SocialAccountAdapter"
